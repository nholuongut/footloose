...
```console
curl -Lo footloose https://github.com/nholuongut/footloose/releases/download/0.6.0/footloose-0.6.0-linux-x86_64
chmod +x footloose
...
```console
curl --silent --location https://github.com/nholuongut/footloose/releases/download/0.6.0/footloose-0.6.0-darwin-x86_64.tar.gz | tar xz
sudo mv footloose /usr/local/bin
```
...
brew install nholuongut/tap/footloose
```
...
```console
GO111MODULE=on go get github.com/nholuongut/footloose
```

[gh-release]: https://github.com/nholuongut/footloose/releases
...
If you want to use [Ignite](https://github.com/nholuongut/ignite) as the backend in order
...
- count: 3
  backend: ignite
  spec:
    image: nholuongut/ignite-centos:7
    name: node%d
    portMappings:
    - containerPort: 22
  ...
  ignite:
    ...
    memory: 1GB
    diskSize: 4GB
    kernel: nholuongut/ignite-ubuntu:4.19.47
```
...
[pkg-config]: https://godoc.org/github.com/nholuongut/footloose/pkg/config
...
- Join the discussion
  - Invite yourself to the <a href="luongutnho@hotmail.com" target="_blank">nholuong</a> nholuong.
  - Ask a question on the [#general](https://github.com/nholuongut/footloosem/messages/general/) nholuong channel.
  - Join the [nholuongut User Group](hnholuongut) and get invited to online talks, hands-on training and meetups in your area.
- [File an issue](https://github.com/nholuongut/footloose/issues/new).
