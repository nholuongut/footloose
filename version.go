...
import (
	...
	release "github.com/nholuongut/footloose/pkg/version"
...
func showVersion(cmd *cobra.Command, args []string) {
	...
	if err != nil {
		fmt.Println("version: failed to check for new versions. You may want to check yourself at https://github.com/nholuongut/footloose/releases.")
		return
	}
